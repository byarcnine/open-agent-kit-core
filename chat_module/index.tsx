 ...
 */
function ChatModule({ apiUrl, agentId, meta }: ChatComponentType) {
  useEffect(() => {
    ...
    const script = loadScript(
      `${apiUrl}/embed/chat.bundle.umd.js`,
      () => {
        try {
          // @ts-ignore
          ...
          // @ts-ignore
          ChatComponent.renderChatComponent(containerId, { agentId, apiUrl, meta });
        } catch (e: any) {
